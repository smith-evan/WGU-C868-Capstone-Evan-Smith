...
public class appointmentsMain {
    ...
    /**
     *
     * Initializes controls and sets up variables and methods for the appointmentsMain.fxml file.
     */
    ...
    /**
     * Goes back to previous view AppointmentView.fxml
     */
    @FXML
    ...
    /**
     * Deletes the selected appointment from the table and database.
     */
    @FXML
    ...
    /**
     * Loads appointments into the table.
     * Lambda #3 fills the allContactNames observable list with contact information.
     */
    @FXML
    void loadAppointment() {
        try {
            ...
            if (selectedAppointment != null) {
                ...
                /**
                 * .setEditable(false) prevents the user from editing the appointment ID.
                 */
    ...
    /**
     * save appointment data on click.
     */
    @FXML
...
//                            (dateTimeEnd.isEqual(checkEnd) || dateTimeEnd.isBefore(checkEnd)))
    ...
    /**
     * Error handling for month radio button
     */
    @FXML
